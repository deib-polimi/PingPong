...
package it.polimi.wifidirect.actionlisteners;
...
public class CustomizableActionListener implements WifiP2pManager.ActionListener {
     ...
     * @param context Context necessary for Toast
     ...
     * @param successToast String that represent the message for Toast in onSuccess
     * @param failLog String that represent the message for Log.d in onFailure. The failure code will be added automatically.
     * @param failToast String that represent the message for Toast in onFailure
     */
